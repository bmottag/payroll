...
<div class="modal-header">
	<h4 class="modal-title">APP Companies Form</h4>
		...
		<div class="row">
			...
			<div class="col-sm-6">
				<div class="form-group text-left">
					...
					<input type="email" class="form-control" id="email" name="email" value="<?php echo $information?$information[0]["company_email"]:""; ?>" placeholder="Email" />
				</div>
			</div>
		</div>
