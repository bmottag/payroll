...
<html lang="en">
    ...
    <body class="hold-transition login-page">
        <div class="login-box">
            ...
            <div class="card card-outline card-primary">
                <div class="card-header text-center">
                    <a href="../../index2.html" class="h1"><b>PAY</b>ROLL</a>
                </div>
                <div class="card-body">
                    ...
                    <form  name="form" id="form" role="form" method="post" action="<?php echo base_url("login/validateUser"); ?>" >
                        ...
                        <div class="form-group input-group mb-3">
                            <input type="text" id="inputLogin" name="inputLogin" class="form-control"  placeholder="User" required autofocus>
                        ...
                        <div class="form-group  input-group mb-3">
                            <input type="password" id="inputPassword" name="inputPassword" class="form-control" placeholder="Password" value="" >
                            <div class="input-group-append">
                                <div class="input-group-text">
        ...
        <!-- jquery-validation -->
        <script src="<?php echo base_url("assets/AdminLTE-3.1.0/plugins/jquery-validation/jquery.validate.min.js"); ?>"></script>
        <script src="<?php echo base_url("assets/AdminLTE-3.1.0/plugins/jquery-validation/additional-methods.min.js"); ?>"></script>
        <!-- AdminLTE App -->
