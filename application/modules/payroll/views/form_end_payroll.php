	...
	<div class="card card-primary card-outline">
		<div class="card-body row">
			<div class="col-5 text-center d-flex align-items-center justify-content-center">
				<div class="">
					<h2 class="text-primary">Finish <strong>Shift</strong></h2>
					<p class="lead mb-5">
						<?php echo $record[0]["first_name"] . " " . $record[0]["last_name"]?><br>
						<strong>Date & Time In: </strong><?php echo $record[0]["start"]?>
					</p>
				</div>
			</div>
			<div class="col-7">
				<form  name="form" id="form" method="post" action="<?php echo base_url("payroll/update_payroll"); ?>" >
				<input type="hidden" id="hddIdentificador" name="hddIdentificador" value="<?php echo $record[0]["id_payroll"]; ?>"/>
